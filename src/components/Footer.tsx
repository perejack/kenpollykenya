  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: "Baby & Kids", to: "/category/baby-kids" },
      ]
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              <div className="bg-gradient-secondary text-secondary-foreground p-3 rounded-lg transform rotate-45 mr-3">
                <div className="transform -rotate-45 font-bold text-lg">
                  KENPOLY
                </div>
              </div>
            </div>
            <p className="text-sm text-primary-foreground/80 mb-6 leading-relaxed">
              Better Plastics, Better Living. With nearly 50 years of experience, 
              we're Kenya's leading manufacturer of quality household and industrial plastics.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-sm text-primary-foreground/60">
                © 2024 Kenpoly Manufacturers Limited. All rights reserved.
              </div>
            </div>
          </div>
        </div>
